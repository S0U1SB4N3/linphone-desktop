...
#include "../../../../../../src/app/single-application/SingleApplicationPrivate.hpp"
...
const QMetaObject SingleApplicationPrivate::staticMetaObject = {
...
void *SingleApplicationPrivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SingleApplicationPrivate.stringdata0))
        return static_cast<void*>(const_cast< SingleApplicationPrivate*>(this));
