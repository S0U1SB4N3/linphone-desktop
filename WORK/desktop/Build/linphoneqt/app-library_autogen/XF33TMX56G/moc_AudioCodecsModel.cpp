...
#include "../../../../../../src/components/codecs/AudioCodecsModel.hpp"
...
const QMetaObject AudioCodecsModel::staticMetaObject = {
    { &AbstractCodecsModel::staticMetaObject, qt_meta_stringdata_AudioCodecsModel.data,
      qt_meta_data_AudioCodecsModel,  qt_static_metacall, nullptr, nullptr}
};
...
void *AudioCodecsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AudioCodecsModel.stringdata0))
        return static_cast<void*>(const_cast< AudioCodecsModel*>(this));
