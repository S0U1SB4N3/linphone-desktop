...
#include "../../../../../../src/components/other/text-to-speech/TextToSpeech.hpp"
...
void TextToSpeech::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TextToSpeech *_t = static_cast<TextToSpeech *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject TextToSpeech::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TextToSpeech.data,
      qt_meta_data_TextToSpeech,  qt_static_metacall, nullptr, nullptr}
};
...
void *TextToSpeech::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TextToSpeech.stringdata0))
        return static_cast<void*>(const_cast< TextToSpeech*>(this));
