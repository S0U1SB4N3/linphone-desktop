...
#include "../../../../../../src/components/timeline/TimelineModel.hpp"
...
const QMetaObject TimelineModel::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_TimelineModel.data,
      qt_meta_data_TimelineModel,  qt_static_metacall, nullptr, nullptr}
};
...
void *TimelineModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TimelineModel.stringdata0))
        return static_cast<void*>(const_cast< TimelineModel*>(this));
